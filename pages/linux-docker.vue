<template>
    <div class="max-w-4xl mx-auto">
      <div class="px-5">
          <div class="pt-10 md:pt-12 text-xl md:text-2xl text-gray-700 font-semibold mb-2">Linux & Docker ({{ articles.length }})</div>
          <div class="text-gray-600 font-normal text-sm md:text-base">리눅스 & 도커 주제를 담은 글 모음입니다. 다른 주제의 글을 보고싶다면 아래 태그를 클릭하세요.</div>
      </div>
      ...
      link: [
        {
            hid: "canonical",
            rel: "canonical",
            href: 'https://blog.harampark.com/linux-docker'
        },
    ],
    },
  }
